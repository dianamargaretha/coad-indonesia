...
const highSpeedDoor = () => {
    ...
    return (
        <div className='section-product'>
            <PublicHead title="high speed door indonesia , industrial door, rapid door, high speed rolling door- convenience auto door | K-1(Standard Model) | Speed door | Product | COAD" />
