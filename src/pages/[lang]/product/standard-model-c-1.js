        ...
        <Link href={{
            ...
            <div className='benefit relative flex justify-center items-center'>
                ...
                <Image
                    ...
                    priority
                />
                <div className='absolute bg-white p-2 text-center text-xs'>{title}</div>
...
const highSpeedDoor = () => {
    ...
    return (
        <div className='section-product'>
            <PublicHead
                title="COAD Indonesia | pintu-high-speed-door, overhead-door, garage-door | C-1(Standard Model) | Speed door | Product | COAD"
				...
				canonical='/product/standard-model-c-1' />
