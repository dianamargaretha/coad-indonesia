...
const index = () => {
    ...
    return (
        <div className='section-product'>
            <PublicHead
                title="COAD Indonesia | pintu-high-speed-door, overhead-door, garage-door | industrial overhead door 30 | Product | COAD"
				...
				canonical='/product/industrial-overhead-door-30' />
            ...
            <div className='py-28 bg-[#f9f9f9]'>
                <div className='container'>
                    ...
                    <div className='flex flex-wrap gap-4'>
                        <Benefit link='stacking-overhead-door-20' lang={lang} thumb={'/assets/coad-images/product/COAD-20-Stacking-Overhead-Door/1.png'} title='COAD-20 Stacking Overhead Door' />
                    </div>
                </div>
            </div>
        </div>
