...
const highSpeedDoor = () => {
    ...
    return (
        <div className='section-product'>
            <PublicHead titile="high speed door indonesia , industrial door, rapid door, high speed rolling door- convenience auto door | K-2(Slim Model) | Speed door | Product | COAD" />
